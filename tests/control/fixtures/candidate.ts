...
export async function candidateCase() {
 ...
 const candidate:Candidate={...h.claim,checkpointId:"cp1",usageHighWater:2,result:"complete",artifacts:[...archive.artifacts,source,stopSource],snapshot:archive.snapshot,missing:[],unresolvedRequestIds:[],stopProof:proof,terminalOutcome:"succeeded"};
 return {...h,candidate};
}
