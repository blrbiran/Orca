...
const rows: Row[] = [
  ...
  ["git branch --move x main", {}, merge],
  ["git branch --copy x main", {}, merge],
  ...
  ["pushd /x && git merge y", ON_FEAT, unclear("cannot resolve the directory of pushd")],
  ["git rebase x && git merge y", ON_FEAT, unclear("an earlier git call in this command may have switched branches")],
  ["git switch main && git merge y", ON_FEAT, unclear("an earlier git call in this command may have switched branches")],
